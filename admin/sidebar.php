            ...
            <div class="page-sidebar"">
                ...
                <ul class="x-navigation">
                    ...
                    <li>
                        <a href="started.php"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>
                    </li>    
                    <!-- <li class="xn-title">Módulos</li>           -->
                    <li class="xn-title">Site</li>
                    <li class="l_cont_site xn-openable">
                        ...
                        <li class="l_banner xn-openable">
                            ...
                            <ul>
                                <li><a href="cadastroBanner.php"><span class="fa fa-plus"></span> Adicionar</a></li>
                                <li><a href="listaBanner.php"><span class="fa fa-list-ul"></span> Listar</a></li>
                            </ul>
                        </li>
